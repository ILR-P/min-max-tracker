      ...
      <form className="workout-form" onSubmit={handleSubmit}>
        ...
        <footer className="workout-footer">
          <div>
            ...
            <strong>{status === 'saving' ? 'Saving logs' : status === 'saved' ? 'Saved' : 'Ready'}</strong>
          </div>
          {error ? <p className="error-message">{error}</p> : <p>Reference the previous week, then log your working sets.</p>}
